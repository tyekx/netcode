...
batch.CreateResources(device);

IUploadResource* someResource;
someResource->UploadResources(batch);
--- the upload will consist of an upload and a transition call ---


batch.Process(directQueue, copyQueue);
--- a batch can be reused after the process call ---
