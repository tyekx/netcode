...
void ::EggEditor::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::EggEditor::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
    ...
    case 1:
        {
            ...
            (safe_cast<::Windows::UI::Xaml::Controls::Page^>(element1))->Loaded += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::EggEditor::MainPage::*)
    ...
    case 7:
        {
            ...
            (safe_cast<::Windows::UI::Xaml::Controls::SwapChainPanel^>(this->swapChainPanel))->SizeChanged += ref new ::Windows::UI::Xaml::SizeChangedEventHandler(this, (void (::EggEditor::MainPage::*)
                (::Platform::Object^, ::Windows::UI::Xaml::SizeChangedEventArgs^))&MainPage::SwapChainPanel_SizeChanged);
            (safe_cast<::Windows::UI::Xaml::Controls::SwapChainPanel^>(this->swapChainPanel))->PointerPressed += ref new ::Windows::UI::Xaml::Input::PointerEventHandler(this, (void (::EggEditor::MainPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::EggEditor::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
