...
class EditorFrameGraph {
	...
	void CreateBoneVisibilityPass(FrameGraphBuilder & builder) {
		builder.CreateRenderPass("Bone visibility pass", [](IResourceContext * ctx) ->void { },
			[this](IRenderContext * ctx) -> void {
	...
	void CreateBackgroundPass(FrameGraphBuilder & builder) {
		builder.CreateRenderPass("Background pass", [](IResourceContext * ctx) ->void { },
			[this](IRenderContext * ctx) -> void {
